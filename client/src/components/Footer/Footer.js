    ...
    <footer className={styles.Footer}>
      <Row>
        <Col span={12}>
          ...
          <Text>
            This is a bulletin board built using the MERN stack (Mongoose,
            Express, React and Node) and Ant Design as the UI framework. Using
            JSON Web Tokens, the user can{' '}
            <Link href="/register">create an account</Link> and{' '}
            <Link href="/register">authenticate</Link>, consuming an API with
            CRUDs and other operations for categories, subcategories, users,
            user groups, topics and posts.
          </Text>
          <br />
          <br />
          <Text>
